...
// CODE HERE
//const evenNumbers  = mixedNumbers.filter(Callback)
...
const postTax = prices.map(prices => prices * 1.07);
...
// CODE HERE
const orderTotal = orders.map(orders  => orders.price * (orders.tax + 1));
...
// CODE HERE
const bobsTotal = purchases.reduce(function(acc, current){
